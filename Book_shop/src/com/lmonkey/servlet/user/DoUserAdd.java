...
@WebServlet(name = "Servlet",urlPatterns = "/manage/admin_douseradd")
public class DoUserAdd extends HttpServlet {
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//成功或失败处理
		if (rs){
			response.sendRedirect("/Book_shop/web/manage/admin_douserselect");
		}else {
			PrintWriter out = response.getWriter();
			out.write("<script>");
			out.write("alert('添加用户失败！')");
			out.write("location.href('/Book_shop/web/manage/Admin_useradd.jsp')");
			out.write("</script>");
		}
	}
