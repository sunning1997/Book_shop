...
<!-----------------address------------------------------->
<div class="address">
	<div class="wrapper clearfix"><a href="selectCateIndex">首页</a><span>/</span><a
			href="flowerDer.html">装饰摆件</a><span>/</span>
		<a href="selectProductList" class="on">${proList}</a>
	</div>
</div><!-------------------current---------------------->
<div class="current">
	<div class="wrapper clearfix"><h3 class="fl">${proList}</h3>
...
<ul class="proList wrapper clearfix">
	...
	<li><a href="productDetail?id=${product.PRODUCT_ID}">
		<dl>
			<dt><img src="image/product/${product.PRODUCT_FILENAME}"></dt>
			<dd>【图书】${product.PRODUCT_NAME}</dd>
