...
<div class="cart mt"><!-----------------logo------------------->
    ...
    <div class="site"><p class=" wrapper clearfix"><span class="fl">购物车</span><img class="top"
            ...
            href="selectCateIndex" class="fr">继续购物&gt;</a></p></div><!-----------------table------------------->
    <div class="table wrapper">
        ...
        <div class="th">
            <div class="pro clearfix"><label class="fl"><input type="checkbox"/><span></span></label>
                <a class="fl" href="productDetail?id=${cartList.CART_PRO_ID}">
                <dl class="clearfix">
                    <dt class="fl"><img width="120px" height="120px" src="image/product/${cartList.CART_PRO_FILENAME}"></dt>
                    <dd class="fl"><p>${cartList.CART_PRO_NAME}</p>
                        <p>图书分类:</p>
                        <p>好书+内容全</p></dd>
                </dl>
            </a></div>
            <div class="price">￥${cartList.CART_PRO_PRICE}</div>
            <div class="number">
                <p class="num clearfix">
                    <img class="fl sub" src="img/temp/sub.jpg">
                    <span datasrc="${cartList.CART_ID}" class="fl">${cartList.CART_QUANTITY}</span>
                    <img class="fl add" src="img/temp/add.jpg">
                </p>
            </div>
            <div class="price sAll">￥${cartList.CART_PRO_PRICE * cartList.CART_QUANTITY}</div>
            <div class="price"><a class="del" data-src="${cartList.CART_ID}" href="#2">删除</a></div>
        </div>
        </c:forEach>
