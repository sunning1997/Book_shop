...
<div class="address mt" id="add">
		<div class="wrapper clearfix"><a href="/Book_shop/web/login?userName=${username.USER_ID}&passWord=${username.USER_PASSWORD}" class="fl">首页</a><span>/</span><a href="mygxin.jsp" class="on">个人中心</a>
	</div>
</div><!------------------------------Bott------------------------------>
<div class="Bott">
	<div class="wrapper clearfix">
		<div class="zuo fl">
			<h3><a href="#"><img src="img/tx.png"/></a>
				<p class="clearfix"><span class="fl">[${username.USER_ID}]</span><span class="fr"><a href="logout">[退出登录]</a></span></p></h3>
			<div><h4>我的交易</h4>
				<ul>
		...
		<div class="you fl">
			<div class="tx clearfix">
				<div class="fl clearfix"><a href="#" class="fl"><img src="img/tx.png"/></a>
					<p class="fl"><span>${username.USER_ID}</span><a href="mygrxx.html">修改个人信息></a></p></div>
				<div class="fr">绑定邮箱：${username.USER_EMAIL}</div>
			</div>
			<div class="bott">
