...
<!-----------------address------------------------------->
<div class="address">
    <div class="wrapper clearfix"><a href="selectCateIndex">首页</a><span>/</span>
        <a href="selectProductList?cid=${product.PRODUCT_CID}">${proList}</a><span>/</span>
        <a href="#" class="on">【最家】${product.PRODUCT_NAME}</a>
    </div>
</div><!-----------------------Detail------------------------------>
<div class="detCon">
    <div class="proDet wrapper">
        <div class="proCon clearfix">
            <div class="proImg fl"><img class="det" src="image/product/${product.PRODUCT_FILENAME}"/>
                <div class="smallImg clearfix">
                    <img src="image/product/${product.PRODUCT_FILENAME}"
                                                    data-src="image/product/${product.PRODUCT_FILENAME}">
                    <img
                        src="image/product/${product.PRODUCT_FILENAME}" data-src="image/product/${product.PRODUCT_FILENAME}">
            ...
            <div class="fr intro">
                <div class="title"><h4>【最家】${product.PRODUCT_NAME}</h4>
                    <p>【破损补寄】【${product.PRODUCT_DESCRIPTION}】【无理由退换货】【包邮】【${proList}】</p><span>￥${product.PRODUCT_PRICE}</span></div>
                <div class="proIntro"><p>颜色分类</p>
                    <div class="smallImg clearfix categ"><p class="fl"><img src="image/product/${product.PRODUCT_FILENAME}"
                                                                            alt="${product.PRODUCT_NAME}" height="45px " width="45px"
                                                                            data-src="image/product/${product.PRODUCT_FILENAME}"></p>
                ...
                <div class="btns clearfix">
                    <a href="javascript:cartAdd(${product.PRODUCT_ID},'z',${product.PRODUCT_CID})"><p class="buy fl">立即购买</p></a>
                    <a href="javascript:cartAdd(${product.PRODUCT_ID},'s',${product.PRODUCT_CID})"><p class="cart fr">加入购物车</p></a>
                </div>
            </div>
        </div>
    </div>
...
<div class="introMsg wrapper clearfix">
    ...
    <div class="msgR fr"><h4>为你推荐</h4>
        <div class="seeList">
            ...
            <a href="productDetail?id=${reProduct.PRODUCT_ID}&cid=${reProduct.PRODUCT_CID}">
            <dl>
                <dt><img src="image/product/${reProduct.PRODUCT_FILENAME}"  width="161px" height="243px"></dt>
                <dd style="width: 161px">【图书】${reProduct.PRODUCT_NAME}</dd>
                <dd>￥${reProduct.PRODUCT_PRICE}</dd>
            </dl></a>
            </c:forEach>
    ...
    <div class="bottom">
        ...
        <div class="imgCon bd">
            <div class="likeList clearfix">
                <div>
                    <c:forEach var="lastlyList" items="${lastlyList}">
                        <a href="productDetail?id=${lastlyList.PRODUCT_ID}&cid=${lastlyList.PRODUCT_CID}">
                            <dl>
                                <dt><img src="image/product/${lastlyList.PRODUCT_FILENAME}"  width="216" height="216"></dt>
                                <dd>【图书】${lastlyList.PRODUCT_NAME}</dd>
                                <dd>￥${lastlyList.PRODUCT_PRICE}</dd>
                            </dl></a>
                    </c:forEach>
                </div>
            </div>
...
<script>
    function cartAdd(id,url,cid) {
        var count = document.getElementById("count").innerHTML;
        location.href = 'cartAdd?id='+id+'&count='+count+'&url='+url+'&cid='+cid;
    }
</script>
</body>
</html>